...
const Homepage = ({
  ...
  type: "button"
}, t('to-second-page'))), __jsx(_i18n__WEBPACK_IMPORTED_MODULE_2__["Link"], {
  href: "/salary"
}, __jsx("button", {
  type: "button"
}, "salary")), __jsx("button", {
  onClick: () => _i18n__WEBPACK_IMPORTED_MODULE_2__["Router"].push('/salary')
}, "This will magically prepend locale subpaths"))), __jsx(_components_Footer__WEBPACK_IMPORTED_MODULE_4__["default"], null));
...
module.exports = __webpack_require__(/*! D:\React learning\next-i18next\examples\simple\pages\index.js */"./pages/index.js");
